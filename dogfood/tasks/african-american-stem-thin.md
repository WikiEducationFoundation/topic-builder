...
run_topic_name: african-american-stem ratchet-2026-04-23-thin
---
...
1. Call `start_topic(name="african-american-stem ratchet-2026-04-23-thin", wiki="en", fresh=False)`. Use the EXACT name — the scoring script looks up the topic by this string. There is a separate, frozen baseline topic with a related name that you must NOT overwrite.
